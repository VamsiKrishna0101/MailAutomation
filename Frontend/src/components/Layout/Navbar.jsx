    ...
    <>
      ...
      <nav className="fixed top-0 left-0 w-full bg-white z-50 shadow-md py-2 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Link to="/" className="text-gray-700 font-medium hover:text-black text-sm">Home</Link>
          <Link to="/builder" className="text-gray-700 font-medium hover:text-black text-sm">Builder</Link>
          <Link to="/addcampaign" className="text-gray-700 font-medium hover:text-black text-sm">Campaigns</Link>
          <Link to="/about" className="text-gray-700 font-medium hover:text-black text-sm">About</Link>
        </div>
